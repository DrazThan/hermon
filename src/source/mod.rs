...
/// The last event observed in a session's transcript. File-backed sources populate this; DB-backed sources (Hermes, OpenCode) leave
...
pub struct SessionMeta {
    ...
    /// Claude and Grok fill this; DB sources leave `None`.
